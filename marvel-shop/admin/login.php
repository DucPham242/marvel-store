	...
	<div class="container" >
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 col-xs-10 col-lg-6" >
				<div class="row">
					<h3 style="text-align: center;">Marvelstore.vn </h3>
					<h4 style="text-align: center;color: gray"> Đăng nhập vào chức năng quản trị</h4>
					<hr><br>
					<form action="" method="POST" role="form"  id="frm_login-admin" >
						...
						<table>
							...
							<tr><td><div class="form-group" style="width:400px;margin: 0 auto;">
