	...
	<div class="container" >
		<div class="row" id="box_show_product" >
			<ol class="breadcrumb" >
				<li>Trang chủ</li>
				<li>Transformer</li>
				<li>BMB LS-01 Nitro Zeus</li>
			</ol>
			<div class="col-md-2" >
				<div class="row">
					<div class="col-md-6"><img class="list_img_product" src="../images/product/marvel/phu_kien/CỐC BÚA THOR/1.jpg" alt="" width=""></div>
					<div class="col-md-6"><img class="list_img_product" src="../images/product/marvel/phu_kien/CỐC BÚA THOR/2.jpg" alt="" width=""></div>

					<div class="col-md-6"><img class="list_img_product" src="../images/product/marvel/phu_kien/CỐC BÚA THOR/3.jpg" alt="" width=""></div>

					<div class="col-md-6"><img class="list_img_product" src="../images/product/marvel/phu_kien/CỐC BÚA THOR/4.jpg" alt="" width=""></div>
			...
			<div class="col-md-5" >
				<img src="../images/product/marvel/phu_kien/CỐC BÚA THOR/1.jpg" alt="" width="450px" id="at_img">
			</div>
