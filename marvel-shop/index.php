...
<body>
	<div class="container" style="">
		...
		<div class="row" style="padding: 10px;position: relative;min-height: 80px;">
			...
			<div class="col-md-3 col-md-push-2" style="padding-top: 5px">
	...
	<!-- <div class="row">
		...
		<div class="row" style="padding-top: 20px">
			<div id="intro1" class="col-md-3 col-sm-6">
				<i style="color: #000" class="fa fa-truck fa-3x" aria-hidden="true"></i>
				<h4>GIAO HÀNG MIỄN PHÍ</h4>
				<p>Tất cả hàng đều được vận chuyển miễn phí khi chuyển khoản trước</p>
			</div>
			<div id="intro2" class="col-md-3 col-sm-6">
				<i style="color: #000" class="fa fa-refresh fa-3x" aria-hidden="true"></i>
				<h4>ĐỔI TRẢ HÀNG</h4>
				<p>Hàng chuẩn như hình thì nhận không chuẩn trả về không mất phí</p>
			</div>
			<div id="intro3" class="col-md-3 col-sm-6">
				<i style="color: #000" class="fa fa-handshake-o fa-3x" aria-hidden="true"></i>
				<h4>GIAO HÀNG NHẬN TIỀN</h4>
				<p>Thanh toán đơn hàng bằng hình thức trực tiếp</p>
			</div>
			<div id="intro4" class="col-md-3 col-sm-6">
				<i style="color: #000" class="fa fa-phone-square fa-3x" aria-hidden="true"></i>
		...
		<div class="row">
			...
			<div class="row">
				<div class="col-md-6 col-md-push-5">
					<a href="file-link/show-all.html"><button type="button" class="btn btn-success btn_viewall">Xem tất cả sản phẩm</button></a>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="row">
					<div class="col-md-6 col-md-push-5">
						<button type="button" class="btn btn-success btn_viewall">Xem tất cả sản phẩm</button>
					</div>
				</div>
				<div class="row">
					<!-- <div class="col-md-12 col-sm-12" > -->
