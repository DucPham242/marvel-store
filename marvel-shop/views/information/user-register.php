...
<div class="container">
		...
		if((isset($_SESSION['noti_regis'])&&$_SESSION['noti_regis']==1) || (isset($_SESSION['noti_regis'])&&$_SESSION['noti_regis']==2) || (isset($_SESSION['noti_regis'])&&$_SESSION['noti_regis']==4)){
				...
				<form action="" method="POST">
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="password" name="repass" class="form-control" placeholder="Nhập lại password...">
					...
					<a href="index.php?page=info&method=login" style="text-decoration: none;color: red">Quay lại</a>
